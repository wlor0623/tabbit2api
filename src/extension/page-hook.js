const TABBIT_COMPLETION_PATH = '/api/v1/chat/completion';
const MESSAGE_SOURCE = 'tabbit-openai-bridge-page-hook';
const TAG = '[TabbitBridge:page-hook]';
...
let currentlyIntercepting = false;
